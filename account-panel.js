...
(function () {
  ...
  style.textContent = [
    ...
    '.ap2-header h2{font-family:"Geist Mono",monospace;font-size:12px;letter-spacing:2px;',
    ...
    '.ap2-section-title{font-family:"Geist Mono",monospace;font-size:9px;letter-spacing:2px;',
    ...
    '.ap2-btn{padding:10px 16px;border-radius:4px;font-family:"Geist Mono",monospace;',
    ...
    '.ap2-plan-badge{display:inline-flex;align-items:center;gap:6px;padding:6px 12px;',
      'border-radius:4px;font-family:"Geist Mono",monospace;font-size:10px;letter-spacing:1px;',
        ...
        '<div class="ap2-card">',
          '<div class="ap2-avatar-row">',
            ...
            '<div>',
              ...
              '<div style="font-family:\u0027Geist Mono\u0027,monospace;font-size:10px;color:#4A4A52;margin-top:2px;" id="ap2-email-display"></div>',
      ...
      '<div class="ap2-section">',
        ...
        '<div class="ap2-card">',
          ...
          '<div id="ap2-ref-content" style="display:none;">',
            '<div style="font-family:\u0027Geist Mono\u0027,monospace;font-size:9px;letter-spacing:1.5px;text-transform:uppercase;color:#4A4A52;margin-bottom:5px;">Your referral link</div>',
