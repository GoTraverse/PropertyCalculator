...
for (const s of suburbs) {
  ...
  let html = SUBURB_TPL
    ...
    .replace(/\{\{OG_IMAGE_URL\}\}/g, `https://equitysight.app/.netlify/functions/og-image?title=${encodeURIComponent(s.suburb)}&subtitle=${encodeURIComponent(s.state + (pc ? ' ' + pc : ''))}&type=suburb`);
...
for (const [cityName, cityDef] of Object.entries(CITY_DEFS)) {
  ...
  let cityHtml = CITY_TPL
    ...
    .replace(/\{\{OG_IMAGE_URL\}\}/g, `https://equitysight.app/.netlify/functions/og-image?title=${encodeURIComponent(cityName)}&subtitle=${encodeURIComponent(cStateName)}&type=city`);
...
for (const state of allStates) {
  ...
  let html = HUB_TPL
    ...
    .replace(/\{\{OG_IMAGE_URL\}\}/g, `https://equitysight.app/.netlify/functions/og-image?title=${encodeURIComponent(stateName)}&subtitle=Australia&type=state`);
