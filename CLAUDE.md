...
**24 HTML pages** (incl. 9 free calculators + showcase) + **14,512 generated suburb pages** (~3,022 indexed post-prune) + **19 city pages** + **8 state hub pages** + **human-authored blog** (Redis CMS → static HTML) | **12 Netlify functions** | **12 CSS files** | **4698+ lines** of calculator logic | **3100+ lines** of admin logic
