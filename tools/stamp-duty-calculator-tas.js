...
function calculate() {
  ...
  document.getElementById('disclaimer').textContent = 'Estimates only. Rates based on Tasmania 2025–26 property transfer duty. Verify with a solicitor before settlement.';
