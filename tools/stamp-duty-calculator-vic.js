...
function calculate() {
  ...
  document.getElementById('disclaimer').textContent = 'Estimates only. Rates based on Victoria 2025–26 land transfer duty. Verify with a solicitor before settlement.';
